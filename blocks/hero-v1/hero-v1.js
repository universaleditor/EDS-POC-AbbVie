...
// UE bindings target elements created here. We guard init to avoid re-wrapping and "infinite" growth.
...
export default function decorate(block) {
  ...
  // 4) Foreground scaffold (create once; do NOT re-append)
  ...
  // 5) Ensure the button anchors exist (href is bound by definition)
  ['1', '2', '3', '4'].forEach((n) => {
  ...
  // 6) Apply background and watch for UE binding updates on data-src
  applyBackground(bg);
  ...
  // 7) Clean: remove accidental empty wrappers from pasted authoring
